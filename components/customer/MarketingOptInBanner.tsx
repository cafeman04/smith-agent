...
export function MarketingOptInBanner() {
  ...
  if (status === "dismissed" || status === "accepted") {
    if (status === "accepted") {
      return (
        <div className="flex items-center gap-2 bg-emerald-50 border border-emerald-200 rounded px-4 py-3 mb-5 text-sm text-emerald-700">
  ...
  return (
    <div className="flex items-center gap-3 bg-blue-50 border border-blue-200 rounded px-4 py-3 mb-5">
      <div className="w-7 h-7 bg-blue-100 border border-blue-200 flex items-center justify-center shrink-0">
